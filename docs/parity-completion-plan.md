...
| [#77](https://github.com/manziman/paseo-gateway/issues/77) | Preserve received permission replies across immediate CLI disconnect | Bounded authorized drain; real two-workspace approval/denial replay |
